...
const ChannelHeaderDropdownButton = ({
    ...
    const restricted = isChannelArchived;
    const withUpsellIcon = !inCall;

    const button = (
        <CallButton
            id='calls-join-button'
            className={
                'style--none call-button-dropdown ' +
            ...
            <div>
                <span className='call-button-label'>
                    {hasCall
                        ...
                        : formatMessage({ defaultMessage: 'Start call' })}
                </span>
                    ...
                    <Tooltip id='tooltip-limit-header'>
                        <Header>
                            {formatMessage(
                                {
                                    defaultMessage:
                                        "There's a limit of {count, plural, =1 {# participant} other {# participants}} per call.",
                                },
